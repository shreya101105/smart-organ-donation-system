    ...
    <nav className={`navbar ${scrolled ? 'shrink' : ''}`}>
      <div className="container navbar-container">
        ...
        <ul className="navbar-menu">
          <li><a href="#about" className="navbar-link">Home</a></li>
          <li><a href="#about" className="navbar-link">About</a></li>
          <li><a href="#features" className="navbar-link">Features</a></li>
          <li><a href="#compatibility" className="navbar-link">AI Prediction</a></li>
          <li><a href="#compatibility" className="navbar-link">Donation</a></li>
          <li><a href="#compatibility" className="navbar-link">Dashboard</a></li>
        ...
        <div className="navbar-actions">
          ...
          {currentUser ? (
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <button className="btn btn-danger" onClick={logout} style={{ padding: '8px 14px', fontSize: '0.85rem' }}>
                Logout
              </button>
            </div>
          ) : (
